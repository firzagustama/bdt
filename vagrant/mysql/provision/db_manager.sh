...
mongo < /vagrant/provision/replication.sql
mongoimport -d passenger -c passenger --type csv /vagrant/passenger.csv --headerline

sudo cp '/vagrant/provision/db_manager.conf' '/etc/mongod.conf'
